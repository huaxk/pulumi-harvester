...
namespace Pulumi.Harvester
{
    ...
    public partial class Image : Pulumi.CustomResource
    {
        ...
        [Output("pvcName")]
        public Output<string?> PvcName { get; private set; } = null!;

        [Output("pvcNamespace")]
        public Output<string?> PvcNamespace { get; private set; } = null!;
    ...
    public sealed class ImageArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("pvcName")]
        public Input<string>? PvcName { get; set; }

        [Input("pvcNamespace")]
        public Input<string>? PvcNamespace { get; set; }
