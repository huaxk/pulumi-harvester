...
require (
	github.com/harvester/terraform-provider-harvester v0.3.2
...
require (
	...
	github.com/harvester/harvester v1.0.0 // indirect
	github.com/harvester/harvester-network-controller v0.2.6 // indirect
	...
	kubevirt.io/client-go v0.45.0 // indirect
